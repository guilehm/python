...
class Personagem:
    def __init__(
        self, nome, vida, p_ataque, p_defesa
    ):  # definir características dos personagens
        self.nome = nome
        self.vida = vida
    ...
    def ataque(self, object, x=100):
        cont = 1
        while (
            self.vivo is True and object.vivo is True and cont <= x
        ):  # loop para ninguém atacar mortos
            if self.vivo is True and object.vivo is True:  # se está vivo, ataca
                ...
                if object.vida <= 0:  # se morreu
                    ...
                    print(
                        f"{self.nome} ataca {object.nome} e inflige: {self.dano:.2f}."
                    )
            if object.vivo is True and self.vivo is True:
                ...
                if self.vida <= 0:
                    ...
                    print(
                        f"{object.nome} ataca {self.nome} e inflige: {object.dano:.2f}."
                    )
