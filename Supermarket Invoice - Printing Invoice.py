...
arquivo.writelines('-'*31)
arquivo.write('\n')
arquivo.writelines(f'{nome:^31}')
arquivo.write('\n')
arquivo.writelines('-'*31)
arquivo.write('\n')
arquivo.writelines('PRODUTO'.ljust(16))
arquivo.write('\n')
arquivo.writelines('-'*31)
arquivo.write('\n')
for i in lista:
    arquivo.writelines((f'{i[0]:19}').title() + (f'R$: {i[1]:>7}')+ '\n')
total = 'TOTAL:'
arquivo.write('\n')
arquivo.writelines('\n')
arquivo.write('\n')
arquivo.writelines(f'{total:19}R$: {soma:>7}')    
arquivo.write('\n')
arquivo.writelines('-'*31)
arquivo.write('\n')
arquivo.writelines('Obrigado por comprar no BARATÂO\nVolte sempre!')
